      ...
      <div className="w-full max-w-md z-10 animate-in fade-in zoom-in duration-500 flex flex-col items-center">
        ...
        <div className="text-center mb-8 w-full">
          <div className="flex items-center justify-center gap-2 mb-2">
            <div className="h-px w-8 bg-linear-to-r from-transparent to-blue-500/50 dark:to-blue-500/30" />
            <p className="text-sm font-semibold text-gray-600 dark:text-gray-400 italic">
              Har delivery ka hisaab, ek hi app mein
            </p>
            <div className="h-px w-8 bg-linear-to-l from-transparent to-blue-500/50 dark:to-blue-500/30" />
          </div>
        </div>

        <Card className="w-full backdrop-blur-xl bg-white/70 dark:bg-gray-950/60 border-gray-200/50 dark:border-gray-800/60 shadow-[0_20px_50px_rgba(31,38,135,0.05)] dark:shadow-[0_20px_50px_rgba(0,0,0,0.5)] rounded-[2.5rem] overflow-hidden group/card relative">
            ...
            <div className="flex flex-col gap-4 pt-4">
              <div className="relative">
                <div className="absolute inset-0 flex items-center">
                  <span className="w-full border-t border-gray-200 dark:border-gray-800 opacity-50"></span>
                </div>
              </div>
