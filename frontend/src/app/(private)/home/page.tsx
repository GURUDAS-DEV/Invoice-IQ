...
import Link from "next/link" // Assuming Link is from Next.js or similar

export default function HomePage() {
  return (
    <div className="p-4 md:p-8 max-w-[1600px] mx-auto space-y-6 md:space-y-8 dark:bg-black">

      {/* Header & Quick Actions */}
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="space-y-1">
          <h1 className="text-3xl md:text-4xl font-black text-gray-900 dark:text-white tracking-tight">Dashboard</h1>
          <p className="text-sm text-gray-500 dark:text-gray-400 font-medium tracking-tight italic opacity-80">Here's your business summary for this month.</p>
        </div>
        <div className="grid grid-cols-2 lg:flex items-center gap-2 md:gap-3">
          <Link href="/sellers" className="flex items-center justify-center gap-2 px-4 h-10 rounded-xl bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 text-gray-700 dark:text-gray-300 text-sm font-bold hover:bg-gray-50 dark:hover:bg-white/10 transition-all active:scale-95 shadow-xs">
            <Plus className="w-4 h-4" />
            <span>Add Seller</span>
          </Link>
          <button className="flex items-center justify-center gap-2 px-3 py-2.5 bg-white dark:bg-[#1A1D24] border border-gray-200 dark:border-white/10 rounded-xl text-xs sm:text-sm font-bold text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-white/5 transition-colors shadow-xs active:scale-95">
            <Plus className="w-4 h-4" />
            Add Delivery
          </button>
          <button className="col-span-2 sm:col-auto flex items-center justify-center gap-2 px-5 py-2.5 bg-linear-to-r from-[#1E3A8A] to-blue-600 hover:from-blue-800 hover:to-blue-700 text-white rounded-xl text-xs sm:text-sm font-bold transition-all shadow-btn active:scale-95">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
        ...
        <div className="bg-white dark:bg-[#1A1D24] border border-gray-100 dark:border-white/10 rounded-2xl p-5 shadow-xs transition-shadow hover:shadow-sm">
          <div className="flex items-center justify-between text-gray-500 dark:text-gray-400 mb-3">
            <span className="text-[11px] font-black uppercase tracking-wider">Total Spend</span>
            <div className="p-2 bg-blue-50 dark:bg-blue-500/10 rounded-lg">
              <IndianRupee className="w-4 h-4 text-[#1E3A8A] dark:text-blue-400" />
            </div>
          </div>
          <div className="flex items-baseline gap-2">
            <h2 className="text-3xl font-black text-gray-900 dark:text-white tracking-tighter">₹1,20,000</h2>
            <span className="text-[10px] font-black text-green-600 dark:text-green-400 flex items-center bg-green-50 dark:bg-green-500/10 px-1.5 py-0.5 rounded-md uppercase">
        ...
        <div className="bg-white dark:bg-[#1A1D24] border border-gray-100 dark:border-white/10 rounded-2xl p-5 shadow-xs transition-shadow hover:shadow-sm">
          <div className="flex items-center justify-between text-gray-500 dark:text-gray-400 mb-3">
            <span className="text-[11px] font-black uppercase tracking-wider">Active Sellers</span>
            <div className="p-2 bg-emerald-50 dark:bg-emerald-500/10 rounded-lg">
              <Users className="w-4 h-4 text-emerald-600 dark:text-emerald-400" />
            </div>
          </div>
          <div className="flex items-baseline gap-2">
            <h2 className="text-3xl font-black text-gray-900 dark:text-white tracking-tighter">8</h2>
            <span className="text-[10px] font-black text-gray-500 dark:text-gray-400 uppercase tracking-tight">Suppliers</span>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-[#1A1D24] border border-gray-100 dark:border-white/10 rounded-2xl p-5 shadow-xs transition-shadow hover:shadow-sm">
          <div className="flex items-center justify-between text-gray-500 dark:text-gray-400 mb-3">
            <span className="text-[11px] font-black uppercase tracking-wider">Total Items</span>
            <div className="p-2 bg-purple-50 dark:bg-purple-500/10 rounded-lg">
              <Package className="w-4 h-4 text-purple-600 dark:text-purple-400" />
            </div>
          </div>
          <div className="flex items-baseline gap-2">
            <h2 className="text-3xl font-black text-gray-900 dark:text-white tracking-tighter">545</h2>
            <span className="text-[10px] font-black text-gray-500 dark:text-gray-400 uppercase tracking-tight">Purchased</span>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-[#1A1D24] border border-red-100 dark:border-red-900/30 rounded-2xl p-5 shadow-xs transition-shadow hover:shadow-sm relative overflow-hidden group">
          ...
          <div className="flex items-center justify-between text-gray-500 dark:text-gray-400 mb-3">
            <span className="text-[11px] font-black uppercase tracking-wider">Price Spikes</span>
            <div className="p-2 bg-red-50 dark:bg-red-500/10 rounded-lg">
              <AlertCircle className="w-4 h-4 text-red-600 dark:text-red-400" />
            </div>
          </div>
          <div className="flex items-baseline gap-2">
            <h2 className="text-3xl font-black text-gray-900 dark:text-white tracking-tighter">2</h2>
            <span className="text-[10px] font-black text-red-600 dark:text-red-400 uppercase tracking-tight">Review</span>
          </div>
        </div>
      </div>
          ...
          <div className="bg-white dark:bg-[#1A1D24] border border-gray-100 dark:border-white/10 rounded-2xl shadow-xs overflow-hidden">
            ...
            <div className="divide-y divide-gray-100 dark:divide-white/5">
              ...
              <div className="p-6 hover:bg-gray-50/50 dark:hover:bg-white/2 transition-colors group">
                ...
                <div className="flex flex-wrap items-center gap-4 md:gap-6 mt-4 text-sm bg-gray-50 dark:bg-white/5 rounded-xl p-3">
                  <div className="flex flex-col sm:flex-row sm:items-baseline gap-1 sm:gap-2">
                    <span className="text-gray-500 dark:text-gray-400 text-[10px] font-black uppercase tracking-wider mb-0.5">WAS</span>
                    <span className="font-bold text-gray-900 dark:text-gray-300">₹100</span>
                  </div>
                  <ArrowRight className="w-4 h-4 text-gray-300 dark:text-gray-600 shrink-0 rotate-90 sm:rotate-0" />
                  <div className="flex flex-col sm:flex-row sm:items-baseline gap-1 sm:gap-2">
                    <span className="text-gray-500 dark:text-gray-400 text-[10px] font-black uppercase tracking-wider mb-0.5">NOW</span>
                    <span className="font-black text-red-600 dark:text-red-400">₹120</span>
                  </div>
                </div>
              </div>
              ...
              <div className="p-6 hover:bg-gray-50/50 dark:hover:bg-white/2 transition-colors group">
                ...
                <div className="flex flex-wrap items-center gap-4 md:gap-6 mt-4 text-sm bg-gray-50 dark:bg-white/5 rounded-xl p-3">
                  <div className="flex flex-col sm:flex-row sm:items-baseline gap-1 sm:gap-2">
                    <span className="text-gray-500 dark:text-gray-400 text-[10px] font-black uppercase tracking-wider mb-0.5">WAS</span>
                    <span className="font-bold text-gray-900 dark:text-gray-300">₹150</span>
                  </div>
                  <ArrowRight className="w-4 h-4 text-gray-300 dark:text-gray-600 shrink-0 rotate-90 sm:rotate-0" />
                  <div className="flex flex-col sm:flex-row sm:items-baseline gap-1 sm:gap-2">
                    <span className="text-gray-500 dark:text-gray-400 text-[10px] font-black uppercase tracking-wider mb-0.5">NOW</span>
                    <span className="font-black text-red-600 dark:text-red-400">₹165</span>
                  </div>
                </div>
              </div>
          ...
          <div className="bg-white dark:bg-[#1A1D24] border border-gray-100 dark:border-white/10 rounded-2xl shadow-xs overflow-hidden pb-2">
            ...
            <div className="overflow-x-auto no-scrollbar px-1">
              <table className="w-full text-left border-collapse min-w-[500px]">
                <thead>
                  <tr className="bg-gray-50/50 dark:bg-white/2 text-xs font-black uppercase tracking-widest text-gray-500 dark:text-gray-400 border-b border-gray-100 dark:border-white/10">
            ...
            <div className="flex items-end justify-between h-28 gap-2 px-1">
              <div className="flex-1 flex flex-col items-center gap-3 group cursor-pointer">
                <div className="w-full bg-blue-100 dark:bg-blue-900/30 rounded-t-lg h-[40%] group-hover:bg-blue-200 dark:group-hover:bg-blue-800/40 transition-colors relative">
                  <span className="absolute -top-7 left-1/2 -translate-x-1/2 text-[10px] font-black tracking-tight text-gray-600 dark:text-gray-300 opacity-0 group-hover:opacity-100 transition-opacity">80K</span>
                </div>
                <span className="text-[10px] text-gray-500 dark:text-gray-400 font-bold uppercase tracking-widest">Jan</span>
              </div>
              <div className="flex-1 flex flex-col items-center gap-3 group cursor-pointer">
                <div className="w-full bg-blue-300 dark:bg-blue-700/50 rounded-t-lg h-[65%] group-hover:bg-blue-400 dark:group-hover:bg-blue-600/60 transition-colors relative">
                  <span className="absolute -top-7 left-1/2 -translate-x-1/2 text-[10px] font-black tracking-tight text-gray-700 dark:text-gray-200 opacity-0 group-hover:opacity-100 transition-opacity">1.1L</span>
                </div>
                <span className="text-[10px] text-gray-500 dark:text-gray-400 font-bold uppercase tracking-widest">Feb</span>
              </div>
              <div className="flex-1 flex flex-col items-center gap-3 group cursor-pointer">
                <div className="w-full bg-[#1E3A8A] dark:bg-blue-500 rounded-t-lg h-[95%] group-hover:bg-blue-800 dark:group-hover:bg-blue-400 transition-colors relative shadow-sm">
                  <span className="absolute -top-7 left-1/2 -translate-x-1/2 text-[10px] font-black tracking-tight text-gray-900 dark:text-white opacity-0 group-hover:opacity-100 transition-opacity">1.2L</span>
                </div>
                <span className="text-[10px] text-gray-900 dark:text-white font-black uppercase tracking-widest">Mar</span>
              </div>
            </div>
          </div>
