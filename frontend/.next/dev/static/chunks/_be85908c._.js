...
"[project]/src/components/Delivery/ClientSide.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ClientSide() {
    ...
    const selectedOption = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ClientSide.useMemo[selectedOption]": ()=>deliveryOptions.find({
                "ClientSide.useMemo[selectedOption]": (option)=>option.id === selectedMode
            }["ClientSide.useMemo[selectedOption]"]) || deliveryOptions[0]
    }["ClientSide.useMemo[selectedOption]"], [
        selectedMode
    ]);
...
_s(ClientSide, "3wuuPBnWLeKNuXFwUT4iBo/+yO8=");
_c = ClientSide;
var _c;
__turbopack_context__.k.register(_c, "ClientSide");
...
//# sourceMappingURL=_be85908c._.js.map